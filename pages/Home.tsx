...
const Home: React.FC = () => {
  ...
  return (
    <div className="min-h-screen transition-colors duration-300 overflow-x-hidden bg-transparent">
            ...
            <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
                ...
                >
                    ...
                    <motion.div 
                        ...
                        className="relative z-20 bg-white/80 dark:bg-slate-800/80 backdrop-blur-md rounded-3xl p-3 sm:p-4 shadow-2xl border border-white/40 dark:border-slate-700/40 transform rotate-y-6 rotate-x-6 hover:rotate-0 transition-transform duration-700 ease-out"
                    >
                         <div className="w-full h-[250px] sm:h-[350px] bg-slate-200 dark:bg-slate-700 rounded-2xl overflow-hidden relative">
                            <img 
                         ...
                         <div className="absolute bottom-6 left-6 right-6 sm:bottom-8 sm:left-8 sm:right-8 bg-white/95 dark:bg-slate-900/95 backdrop-blur-md p-3 sm:p-4 rounded-xl shadow-lg flex items-center justify-between border border-white/20">
                            <div>
                                <p className="text-[10px] sm:text-xs text-slate-500 dark:text-slate-400 uppercase tracking-wider font-bold">Featured Listing</p>
                                <h3 className="text-sm sm:text-lg font-bold text-slate-900 dark:text-white truncate max-w-[120px] sm:max-w-none">Elite Marine Villa</h3>
                            </div>
                    ...
                    <motion.div 
                        ...
                        className="absolute -top-6 -right-4 sm:-top-10 sm:-right-10 z-30 bg-white/90 dark:bg-slate-800/90 backdrop-blur-md p-3 sm:p-4 rounded-2xl shadow-xl border border-white/50 dark:border-slate-700 w-40 sm:w-48 scale-90 sm:scale-100"
                    >
                        <div className="flex items-center gap-3 mb-2">
                            ...
                            <div>
                                ...
                                <p className="text-[10px] sm:text-xs text-slate-500">Physical Check</p>
                            </div>
                        </div>
                    ...
                    >
                        <div className="flex -space-x-3">
                            <img src="https://i.pravatar.cc/100?img=11" className="w-8 h-8 sm:w-10 sm:h-10 rounded-full border-2 border-white dark:border-slate-800" alt="" />
                            <img src="https://i.pravatar.cc/100?img=12" className="w-8 h-8 sm:w-10 sm:h-10 rounded-full border-2 border-white dark:border-slate-800" alt="" />
                            <img src="https://i.pravatar.cc/100?img=13" className="w-8 h-8 sm:w-10 sm:h-10 rounded-full border-2 border-white dark:border-slate-800" alt="" />
                        </div>
                        <div>
                            <p className="font-bold text-slate-900 dark:text-white text-sm sm:text-base">12k+</p>
      ...
      <section className="py-20 bg-white/30 dark:bg-slate-900/50 backdrop-blur-sm overflow-hidden border-y border-white/20 dark:border-slate-800/50">
                      ...
                      <div className="relative mx-auto border-gray-800 dark:border-gray-800 bg-gray-800 border-[14px] rounded-[2.5rem] h-[600px] w-[300px] shadow-2xl">
                          ...
                          <div className="rounded-[2rem] overflow-hidden w-full h-full bg-slate-50 dark:bg-slate-900 relative">
                               ...
                               <div className="absolute top-36 w-full p-4 space-y-4">
                                    {[
                                      { img: "https://images.unsplash.com/photo-1512917774080-9991f1c4c750?w=200&h=200&fit=crop", title: "Modern Haven" },
                                      { img: "https://images.unsplash.com/photo-1493809842364-78817add7ffb?w=200&h=200&fit=crop", title: "Sky Loft" },
                                      { img: "https://images.unsplash.com/photo-1542314831-068cd1dbfeeb?w=200&h=200&fit=crop", title: "Heritage Suite" }
                                    ].map((item, i) => (
                                        <div key={i} className="bg-white dark:bg-slate-800 p-3 rounded-xl shadow-sm border border-slate-100 dark:border-slate-700 flex gap-3">
                                            <img src={item.img} className="w-16 h-16 rounded-lg object-cover" alt={item.title} />
      ...
      {/* Call to Action */}
      <section className="bg-slate-900/90 dark:bg-emerald-900/90 backdrop-blur-md py-16 sm:py-20 mt-10 px-4 relative overflow-hidden">
