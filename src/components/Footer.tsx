  ...
  return (
    <footer className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-t border-slate-200 dark:border-slate-800 pt-16 pb-8 text-slate-600 dark:text-slate-400 relative z-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm leading-relaxed text-slate-500 dark:text-slate-400">
              The premier marketplace for luxury rentals and dream homes in India. 
              Experience the comfort of modern living with our curated selection of verified properties.
            </p>
        ...
        <div className="border-t border-slate-100 dark:border-slate-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-center md:text-left">
          <p className="text-xs text-slate-500 dark:text-slate-400">
            © {new Date().getFullYear()} HomeStead Haven. For more details contact the developer at <span className="text-emerald-600 dark:text-emerald-400 font-semibold">sathwikpamu@gmail.com</span>.
          </p>
