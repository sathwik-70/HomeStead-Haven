  ...
  return (
    ...
    >
        <div 
          ...
          className="bg-white/70 dark:bg-slate-800/70 backdrop-blur-md rounded-3xl overflow-hidden shadow-xl shadow-slate-200/50 dark:shadow-black/50 border border-white/50 dark:border-slate-700 cursor-pointer h-full flex flex-col group transition-all duration-300"
        >
            {/* Image Container */}
            <div className="relative h-[260px] w-full overflow-hidden">
                ...
                <div className="absolute bottom-4 left-4 text-white">
                     ...
                     <div className="flex items-baseline gap-2">
                        ...
                        {property.offer && (
                            <span className="text-sm text-slate-400 line-through decoration-emerald-500/50 decoration-2">₹{formatPrice(property.price)}</span>
                        )}
            ...
            {/* Content */}
            <div className="p-6 flex flex-col gap-4 flex-grow relative bg-transparent">
                ...
                {/* Specs Grid */}
                <div className="grid grid-cols-3 gap-2 py-3 border-t border-slate-50/50 dark:border-slate-700/50">
                  <div className="flex flex-col items-center justify-center p-2 rounded-xl bg-slate-50/50 dark:bg-slate-900/50">
                    <Bed size={18} className="text-slate-400 mb-1" />
                    <span className="text-xs font-bold text-slate-700 dark:text-slate-300">{property.bedrooms} BHK</span>
                  </div>
                  <div className="flex flex-col items-center justify-center p-2 rounded-xl bg-slate-50/50 dark:bg-slate-900/50">
                ...
                <div className="mt-auto pt-2">
                  <button 
                      ...
                      className="w-full py-3 bg-gradient-to-r from-emerald-500 to-blue-500 text-white text-sm rounded-xl font-semibold hover:shadow-lg hover:shadow-emerald-500/20 transition-all flex items-center justify-center gap-2 group/btn"
                  >
                      View Details
