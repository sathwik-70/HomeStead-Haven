...
const EditListing: React.FC = () => {
  ...
  if (fetching) return <div className="min-h-screen pt-32 text-center text-slate-600 dark:text-slate-400">Loading listing details...</div>;

  return (
    <div className="p-3 max-w-4xl mx-auto pt-28 pb-20">
      <h1 className="text-3xl font-bold text-center my-7 text-slate-800 dark:text-white">Edit Listing</h1>
      <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-6">
        <div className="flex flex-col gap-4 flex-1">
          <input
            type="text"
            placeholder="Title"
            className="border border-slate-200 dark:border-slate-700 p-3 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all dark:bg-slate-800 dark:text-white"
            id="title"
            required
          ...
          <textarea
            ...
            className="border border-slate-200 dark:border-slate-700 p-3 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all h-32 dark:bg-slate-800 dark:text-white"
            id="description"
            required
            onChange={handleChange}
          ...
          <div className="flex gap-6 flex-wrap">
            ...
            <div className="flex gap-2 items-center">
              ...
              />
              <span className="text-slate-700 dark:text-slate-300">Parking spot</span>
            </div>
            <div className="flex gap-2 items-center">
            ...
            <div className="flex gap-2 items-center">
              ...
              />
              <span className="text-slate-700 dark:text-slate-300">Offer</span>
            </div>
          </div>
          <div className="flex flex-wrap gap-6">
            <div className="flex items-center gap-2">
              <input
                ...
                max="10"
                required
                className="p-3 border border-slate-200 dark:border-slate-700 rounded-xl focus:border-emerald-500 outline-none w-20 dark:bg-slate-800 dark:text-white"
                onChange={handleChange}
            ...
            <div className="flex items-center gap-2">
              ...
              />
              <p className="text-slate-600 dark:text-slate-400">Baths</p>
            </div>
            <div className="flex items-center gap-2">
              <input
                type="number"
                ...
                min="1000"
                required
                className="p-3 border border-slate-200 dark:border-slate-700 rounded-xl focus:border-emerald-500 outline-none w-32 dark:bg-slate-800 dark:text-white"
                onChange={handleChange}
                value={formData.regularPrice}
              />
              <div className="flex flex-col items-center">
                <p className="text-slate-600 dark:text-slate-400">Regular price</p>
            ...
            {formData.offer && (
              <div className="flex items-center gap-2">
                ...
                />
                <div className="flex flex-col items-center">
                  <p className="text-slate-600 dark:text-slate-400">Discounted price</p>
                  <span className="text-xs text-slate-400">(₹ / month)</span>
                </div>
              </div>
            )}
        ...
        <div className="flex flex-col flex-1 gap-4">
          <p className="font-semibold text-slate-700 dark:text-slate-300">Images:</p>
          <div className="flex flex-col gap-2">
            <p className="text-xs text-slate-400">Image URL:</p>
            <input 
                type="text" 
                placeholder="https://..." 
                className="border border-slate-200 dark:border-slate-700 p-2 rounded-xl text-sm dark:bg-slate-800 dark:text-white"
          ...
          {/* Image Preview */}
          {previewImage && (
              <div className="relative w-full h-64 rounded-xl overflow-hidden shadow-sm border border-slate-200 dark:border-slate-700">
